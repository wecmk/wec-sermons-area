 ...
 */
final class Version20190626225159 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE uploaded_file_metadata CHANGE file_location file_location VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE uploaded_file_metadata CHANGE file_location file_location VARCHAR(50) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
