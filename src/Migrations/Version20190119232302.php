 ...
 */
final class Version20190119232302 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sermon (id INT AUTO_INCREMENT NOT NULL, apm_id INT DEFAULT NULL, speaker_id INT DEFAULT NULL, date DATE NOT NULL, reading VARCHAR(255) NOT NULL, second_reading VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, corrupt TINYINT(1) NOT NULL, is_public TINYINT(1) NOT NULL, tags LONGTEXT NOT NULL, public_comments LONGTEXT NOT NULL, private_comments LONGTEXT NOT NULL, INDEX IDX_A4F02DA2DBF4AE6F (apm_id), INDEX IDX_A4F02DA2D04A0F27 (speaker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
